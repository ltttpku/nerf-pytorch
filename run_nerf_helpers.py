...
class ResnetEnc(nn.Module):
    def __init__(self, z_dim, c_dim=3, img_hw=32):
        super().__init__()
        self.img_hw = img_hw
        self.c_dim = c_dim
...
class NeRF(nn.Module):
    def __init__(self, D=8, W=256, input_ch=3, input_ch_views=3, input_code_ch=256, output_ch=4, skips=[4], use_viewdirs=False):
        ...
        self.input_code_ch = input_code_ch
...
def get_rays_sample(H, W, K, c2w, gt_rgb, gt_depth, i, precrop_iters, precrop_frac=0.3, N_rand=1024):
